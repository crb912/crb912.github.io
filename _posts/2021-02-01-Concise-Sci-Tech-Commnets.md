...
发现Windows系统存在一个性能问题:中断时间仅100纳秒，频率似乎过高。而Linux系统通常是4ms(250HZ)，[Philip的回答](https://unix.stackexchange.com/a/549912)提到了Jiffies值过去是10ms(100HZ),后来又改成了1ms(1000HZ)。所以，对于windows系统而言，100纳秒真是合理的数字吗？开发做了严格的测试了吗？恐怕没有。微软为了追求更快的进程调度，不惜对CPU性能负优化。
