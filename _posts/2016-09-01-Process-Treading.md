...
这个博客源于知乎上的一个问题: [指令级并行，线程级并行，数据级并行区别？线程的概念是什么？][1]，因此这篇博文也是我对这个问题的解读。
...
![window任务管理器](https://gss3.bdstatic.com/7Po3dSag_xI4khGkpoWK1HF6hhy/baike/c0%3Dbaike80%2C5%2C5%2C80%2C26/sign=0e2b5a880bfa513d45a7648c5c043e9e/9825bc315c6034a8c17b77d5c8134954082376cd.jpg)
...
## 3.1线程级并发(Thread-Lever Concurrency)
...
### 3.2 线程级并行(Thread-Lever Parallelism)
